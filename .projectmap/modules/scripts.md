...
- `function main` — scripts/check_fit.py:91
...
- `function load_overlay_meta` — scripts/derive_timeline.py:142
- `function build_page_mathwrites` — scripts/derive_timeline.py:165
- `function main` — scripts/derive_timeline.py:213
- `function resolve` — scripts/derive_timeline.py:306
...
- `function isAnimated` — scripts/export_mp4.mjs:297
- `function writeFrame` — scripts/export_mp4.mjs:352
- `function parse_jhf` — scripts/gen_hershey_font.py:26
- `function main` — scripts/gen_hershey_font.py:77
- `function main` — scripts/plan_subagent_batches.py:25
- `function find_chrome` — scripts/render_mathwrite.py:131
- `function make_unique_ids` — scripts/render_mathwrite.py:152
- `function main` — scripts/render_mathwrite.py:157
...
- `function strip_markers` — scripts/synthesize_tts.py:56
- `function parse_args` — scripts/synthesize_tts.py:63
- `function to_simplified` — scripts/synthesize_tts.py:97
- `function resolve_indextts2` — scripts/synthesize_tts.py:132
- `function main` — scripts/synthesize_tts.py:150
- `function seg_path` — scripts/synthesize_tts.py:244
- `function t` — scripts/synthesize_tts.py:308
- `function resolve` — scripts/synthesize_tts.py:365
- `function _find_overlay_cues` — scripts/synthesize_tts.py:398
